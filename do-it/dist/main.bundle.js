...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__todo_service__ = __webpack_require__(98);
...
var ArchiveComponent = (function () {
    ...
    ArchiveComponent.prototype.ngOnInit = function () {
        ...
        this.todoService.todoList$
            ...
            _this.archiveList = list.filter(function (todo) { return todo.isDone; });
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__todo_service__ = __webpack_require__(98);
    ...
    TodoService.prototype.fetchAllTodos = function () {
        ...
        return this.http.get(this.baseURL + ".json")
            ...
            for (var i = 0; i < keysArr.length; i++) {
                ...
                var todoModel = new __WEBPACK_IMPORTED_MODULE_3__models_todo__["a" /* Todo */](todoRspObj.title, todoRspObj.category, key, todoRspObj.isDone, todoRspObj.endDate);
