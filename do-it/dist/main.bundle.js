...
var CheckListComponent = (function () {
    ...
    CheckListComponent.prototype.isOk = function (item) {
        var diffInTime = this.findTotalMsElapsed(item.startDate);
    ...
    CheckListComponent.prototype.findTotalMsElapsed = function (startDate) {
        var currentDate = Date.now();
        var diffInTime = currentDate - startDate;
        return diffInTime;
    };
